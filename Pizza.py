...
#--  page 1------
    def main(sf):
        ...
        sf.scr.iconbitmap('Images/p.ico')
        sf.mainf1=Frame(sf.scr,height=150,width=1366)
        sf.logo=PhotoImage(file="Images/logo1.png")
        ...
        sf.c.pack()
        sf.back=PhotoImage(file="Images/pizzamain.png")
...
#------ page 2------
    def Login(sf):
        ...
        sf.scr.destroy()
        sf.scr=Tk()
        sf.scr.title("LPU's Pizza")
        sf.scr.geometry("1366x768")
        #sf.scr.resizable(False, False)
        sf.loginf1=Frame(sf.scr,height=150,width=1366)
        sf.logo=PhotoImage(file="Images/logo3.PNG")
        ...
        sf.c.pack()
        sf.logo1=PhotoImage(file="Images/pizzamain.png")
        ...
        sf.rg=Button(sf.loginf2,text="New to LPU's Pizza",command=lambda:sf.Register(),fg="white",cursor="hand2",bg="#8c68c1",font=("cooper black",20),bd=6)
        sf.rg.place(x=200,y=390)
        sf.c.create_rectangle(850,120,1310,480,fill="#d3ede6",outline="white",width=4)
        sf.ext=PhotoImage(file="Images/p4.png")
...
#--  page 5------
    def adminmain(sf):
        ...
        sf.c.pack()
        sf.logo=PhotoImage(file="Images/logo2.png")
...
#--  page 6------        
    def menulist(sf,x):
        ...
        sf.veg=PhotoImage(file="Images/veg.png")
        ...
        sf.nonveg=PhotoImage(file="Images/Non.png")
        ...
        sf.chi=PhotoImage(file="Images/chiken.png")
        ...
        sf.side=PhotoImage(file="Images/extra.png")
...
#--  page 7------
    def pizmain(sf):
        ...
        sf.deli=PhotoImage(file="Images/delivery.png")
        sf.c.create_image(540,260,image=sf.deli)
        sf.pic=PhotoImage(file="Images/pick.png")
...
#--  page 8------
    def vegpizza(sf,x):
        ...
        sf.delu=PhotoImage(file="Images/deluxe.png")
        ...
        sf.vag=PhotoImage(file="Images/extravaganza.png")
...
##        ch2=sf.check(sf.vegf2,220)
        ...
        sf.pep=PhotoImage(file="Images/5-pepper-veg-pizza.png")
        ...
        sf.mag=PhotoImage(file="Images/Margherit.png")
...
#--  page 10------
    def nonvegpiz(sf,x):
        ...
        # pizza 1
        sf.c.create_rectangle(405, 50, 960, 170,width=2)
        sf.delu=PhotoImage(file="Images/Non-Veg_Supreme.png")
        sf.c.create_image(470,110,image=sf.delu)
        ...
        #pizza 2
        sf.c.create_rectangle(405, 170, 960, 290,width=2)
        sf.vag=PhotoImage(file="Images/nonChicken_Tikka.png")
        sf.c.create_image(470,230,image=sf.vag)
        ...
        #pizza 3
        sf.c.create_rectangle(405, 290, 960, 410,width=2)
        sf.pep=PhotoImage(file="Images/non-Chicken_Sausage.png")
        sf.c.create_image(470,350,image=sf.pep)
        ...
        #pizza 4
        sf.c.create_rectangle(405, 410, 960, 530,width=2)
        sf.mag=PhotoImage(file="Images/no-LoadedL.png")
        sf.c.create_image(470,470,image=sf.mag)
...
#--  page 11------
    def SpecialChi(sf,x):
        ...
        # pizza 1
        sf.c.create_rectangle(405, 50, 960, 170,width=2)
        sf.delu=PhotoImage(file="Images/roasted.png")
        sf.c.create_image(470,110,image=sf.delu)
        ...
        #pizza 3
        sf.c.create_rectangle(405, 290, 960, 410,width=2)
        sf.pep=PhotoImage(file="Images/Boneless-Chicken-wings-192x192.png")
        sf.c.create_image(470,350,image=sf.pep)
...
#--  page 12------
    def sidebev(sf,x):
        ...
        # pizza 1
        sf.c.create_rectangle(405, 50, 960, 170,width=2)
        sf.delu=PhotoImage(file="Images/coke.png")
        sf.c.create_image(470,110,image=sf.delu)
        ...
        #pizza 2
        sf.c.create_rectangle(405, 170, 960, 290,width=2)
        sf.vag=PhotoImage(file="Images/burger.png")
        sf.c.create_image(470,230,image=sf.vag)
        ...
        #pizza 3
        sf.c.create_rectangle(405, 290, 960, 410,width=2)
        sf.pep=PhotoImage(file="Images/white.png")
        sf.c.create_image(470,350,image=sf.pep)
